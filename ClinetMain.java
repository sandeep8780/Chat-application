...
import java.io.*;
	...
	public class ClinetMain extends JFrame implements ActionListener { // ActionListener abstrat method created is mandatroy
	...
	//step 2...
		...
		// this line is use icone photo (DP for first user)
					ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/virat.jpeg")) ;	
